...
namespace ObsStrawket.DataTypes {
  internal static class DataTypeMapping {
    internal static readonly Dictionary<string, Type> EventToTypes = new Type[] {
      ...
      typeof(SourceFilterSettingsChanged),
    ...
    internal static readonly Dictionary<string, RequestMapping> RequestToTypes = new RequestMapping[] {
      ...
      new (typeof(SetRecordDirectory), typeof(RequestResponse)),
      ...
      new (typeof(CreateScene), typeof(CreateSceneResponse)),
      ...
      // Filters Requests
      new (typeof(GetSourceFilterKindList), typeof(GetSourceFilterKindListResponse), true),
      ...
      new (typeof(GetSceneItemSource), typeof(GetSceneItemSourceResponse)),
